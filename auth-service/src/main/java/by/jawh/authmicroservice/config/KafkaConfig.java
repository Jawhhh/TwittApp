...
public class KafkaConfig {
    ...
    @Bean
    NewTopic userLoginNotificationEventsTopic() {
        return TopicBuilder
                .name("user-login-notification-events-topic")
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    ...
    @Bean
    NewTopic userRegisteredNotificationEventsTopic() {
        return TopicBuilder
                .name("user-registered-notification-events-topic")
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    ...
    @Bean
    NewTopic userRegisteredSubscribeEventsTopic() {
        return TopicBuilder
                .name("user-registered-subscribe-events-topic")
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
